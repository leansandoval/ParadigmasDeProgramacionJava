...
public class InterfazUsuario {
	...
	private void mostrarPromocionesDeItinerario(Itinerario itinerario) {
	...
	private void mostrarAtraccionesDeItinerario(Itinerario itinerario) {
	...
	private void mostrarTotalPorUsuarioDeItinerario(Itinerario itinerario) {
	...
	public void mostrarItinerario(Itinerario itinerario) {
		...
		mostrarPromocionesDeItinerario(itinerario);
		mostrarAtraccionesDeItinerario(itinerario);
		mostrarTotalPorUsuarioDeItinerario(itinerario);
		System.out.println("\n====================================================================================\n");
	}
}
