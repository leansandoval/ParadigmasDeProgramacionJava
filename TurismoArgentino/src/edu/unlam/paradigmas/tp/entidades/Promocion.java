...
public abstract class Promocion implements Comparable<Promocion> {
	...
	public int compareTo(Promocion otraPromocion) {
		int cmpPrecio = Double.compare(this.precioConDescuento, otraPromocion.precioConDescuento);
		return cmpPrecio != 0 ? cmpPrecio : Double.compare(this.duracion, otraPromocion.duracion);
	}
