...
public class OfertadorAtraccionesTest {
	...
	public void queDevuelveAtraccion() {
		...
		AtraccionIteratorImpl atraccionIterator = new AtraccionIteratorImpl(atracciones, usuario);
		Atraccion atraccionObtenida = atraccionIterator.next();
	...
	public void queNoHayAtracciones() {
		...
		AtraccionIteratorImpl atraccionIterator = new AtraccionIteratorImpl(atracciones, usuario);
		boolean resultadoObtenido = atraccionIterator.hasNext();
		Assert.assertEquals(resultadoEsperado, resultadoObtenido);
	}
